...
API_KEY = "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"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
if USE_PROXY:
    ...
    proxies = {
        #          [协议]://  [地址]  :[端口]
	"http": "socks5h://localhost:7890", "https": "socks5h://localhost:7890", 
    }
else:
    proxies = None
